...
interface ScheduleEvent {
  ...
  grade: string;
  room: string;
  students: number; // Added number of students
}

const mockSchedule: Record<string, Record<string, ScheduleEvent>> = {
  'Monday': {
    '08:00 AM': { id: '1', subject: 'Mathematics', teacher: 'John Doe', grade: 'Grade 1 A', room: '301', students: 25 },
    '10:00 AM': { id: '2', subject: 'Physics', teacher: 'Jane Smith', grade: 'Grade 1 B', room: '302', students: 20 },
    '12:00 PM': { id: '5', subject: 'English', teacher: 'Alice Brown', grade: 'Grade 7', room: '305', students: 30 },
  },
  'Wednesday': {
    '09:00 AM': { id: '3', subject: 'Chemistry', teacher: 'Mike Johnson', grade: 'Grade 12', room: '303', students: 15 },
    '02:00 PM': { id: '4', subject: 'Biology', teacher: 'Sarah Wilson', grade: 'Grade 10', room: '304', students: 18 },
    '10:00 AM': { id: '6', subject: 'History', teacher: 'Tom Green', grade: 'Grade 1 C', room: '306', students: 22 },
  },
  'Tuesday': {
    '12:00 PM': { id: '5', subject: 'English', teacher: 'Alice Brown', grade: 'Grade 7', room: '305', students: 30 },
  },
  'Thursday': {
    '10:00 AM': { id: '6', subject: 'History', teacher: 'Tom Green', grade: 'Grade 1 D', room: '306', students: 28 },
  },
};
...
<option value="1C">Grade 1 C</option>
                    ...
                    {event && (
                      <div className="h-full bg-blue-50 rounded-lg p-3 border border-blue-200">
                        ...
                        <div className="text-sm text-gray-600 mt-1 flex items-center">
                          ...
                          {event.teacher} ({event.students} students)
                        </div>
                        <div className="text-sm text-gray-600 mt-1 flex items-center">
